...
export const ChangingSeasonOutfit = ({ SeasonDescription, smallBrandName, TitleShadow, MidBackgroundColors }: Props) => {
...
const Wrapper = styled(motion.div)<{ MidBackgroundColors:string[]}>`
  background: linear-gradient(250deg, 
    ${(props) => props.MidBackgroundColors[0]},
    ${(props) => props.MidBackgroundColors[1]});
  width: 100%;
  height: 100%;
  display: flex;
