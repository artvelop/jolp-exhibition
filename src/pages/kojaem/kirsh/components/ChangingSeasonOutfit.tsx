...
const seasonTitle = "키르시의 편안한 환절기 코디";
...
return (
  ...
  >
      <TitleWrapper>
        ...
        <MidImageContainer>
        <MidImage src={`/kojaem/img/kirsh/${season}Image1.jpg`} show = {showImg1}
        />
        <MidImage src={`/kojaem/img/kirsh/${season}Image2.jpg`} show = {showImg2}
        />
        <MidImage src={`/kojaem/img/kirsh/${season}Image3.jpg`} show = {showImg3}
        />
        </MidImageContainer>
    </Wrapper>
  );
