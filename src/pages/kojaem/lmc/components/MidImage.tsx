...
export const MidImage = ({ show, index, season }: Props) => {
  ...
  const onClickEvent = () => {
    if (!click) {
      const imageClickSrc =
        require(`assets/img/KoJaem/lmc/${season}Image${index}Click.jpg`).default;
      imageRef.current!.src = imageClickSrc;
      setClick(!click);
    } else {
      const imageSrc =
        require(`assets/img/KoJaem/lmc/${season}Image${index}.jpg`).default;
  ...
  return (
    ...
    >
      <Image
        src={
          require(`assets/img/KoJaem/lmc/${season}Image${index}.jpg`)
            .default
        }
        ref={imageRef}
        animate={{
